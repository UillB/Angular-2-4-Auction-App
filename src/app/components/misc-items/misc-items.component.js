...
var MiscItemsComponent = (function () {
    function MiscItemsComponent(mainService) {
        this.mainService = mainService;
    }
    MiscItemsComponent.prototype.ngOnInit = function () {
        this.updateCurrentTime();
        this.miscItems = this.mainService.getMiscItems();
        this.getServItems();
    };
    MiscItemsComponent.prototype.updateCurrentTime = function () {
        var _this = this;
    ...
    MiscItemsComponent.prototype.onSelect = function (item) {
        this.selectedItem = item;
        if (this.selectedItem && this.selectedItem.BidCount === 0) {
            this.selectedItem.HighestBid = {};
        }
    };
    MiscItemsComponent.prototype.placeBid = function () {
    ...
    MiscItemsComponent.prototype.getServItems = function () {
        this.mainService.getItemsFromServer();
    };
    return MiscItemsComponent;
}());
MiscItemsComponent = __decorate([
    core_1.Component({
        selector: 'misc-items',
...
exports.MiscItemsComponent = MiscItemsComponent;
//# sourceMappingURL=misc-items.component.js.map